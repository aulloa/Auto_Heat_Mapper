...
% Last Modified by GUIDE v2.5 04-Dec-2015 06:18:58
...
function [handles1] = pushbutton1_Callback(hObject, eventdata, handles)
...
image = importdata(complete);
setappdata(0,'MyStruct',image)
setappdata(0,'MyStruct3',complete)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[fn2 pn2] = uigetfile('*.*','select XY Data');
complete2 = strcat(pn2,fn2);
set(handles.edit2,'string',complete2);
S = uiimport(complete2);
setappdata(0,'MyStruct2',S)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[fn3 pn3] = uiputfile('*.*','Select Save Folder');
complete3 = strcat(pn3,fn3);
set(handles.edit3,'string',complete3);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
I = getappdata(0,'MyStruct');
D = getappdata(0,'MyStruct2')
C = getappdata(0,'MyStruct3')
Auto_Heat_Mapper(I,D,C)
